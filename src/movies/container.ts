...
import { ActorsRepository, CountryRepository, GenresRepository, MoviesRepository, ReviewsRepository } from "./repositories";
...
export class Container {
  ...
  constructor() {
    ...
    const moviesService = new MoviesService(moviesRepo, genresRepo, actorsRepo, reviewsRepo, countryRepo);
